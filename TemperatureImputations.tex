...
at four Iowa weather stations. However, the Iowa data includes X
...
The entire model therefore has 3 parameters: \(\sigmaf\), \(\ell\), and
\(\sigman\). By optimizing the marginal likelihood of the Iowa data as a
function of these three parameters, we obtained
\(\sigmaf=3.73\,\degreeC\), \(\ell=176.4\,\mathrm{km}\) and
\(\sigman=0.44\,\degreeC\).
