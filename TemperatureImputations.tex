...
\begin{align}
    ...
    \Sigma_{\miss \mid \obs} &= \var \del{\T_\miss \mid \T_\obs} = \cov\del{\T_\miss,\T_\miss} - \cov\del{\T_\miss, \T_\obs} \cov\del{\T_\obs, \T_\obs}^{-1} \cov\del{\T_\obs, \T_\miss}\,. \\ %_
\end{align}
...
\eqref{eq:gp_variogram}, resulting in Figure\textasciitilde{}(XX).
...
\toprule
Model & Likelihood & Var(err) & E(Var(err)) & MSE(err) &
E(MSE(err))\tabularnewline
\midrule
\endhead
SE x SE & 55,614 & 1.565 & 0.855 & 1.435 & 0.680\tabularnewline
SExSE + diurnal & 54,472 & 1.414 & 0.959 & 1.275 & 0.747\tabularnewline
Sum of products & 47,082 & 1.244 & 2.031 & \textasciitilde{}1.181 &
\textasciitilde{}0.959\tabularnewline
SoP, fixed variance & 48,589 & 3.813 & 7.619 & &\tabularnewline
(time sum) x SE & 52,467 & 1.439 & 17.996 & &\tabularnewline
\bottomrule
\end{longtable}
